...
<p class="readmore mt-4">
	...
	<?php elseif ($params->get('show_readmore_title', 0) == 0) : ?>
		<a class="btn btn-primary btn-sm" href="<?php echo $displayData['link']; ?>" itemprop="url" aria-label="<?php echo JText::_('COM_CONTENT_READ_MORE'); ?> <?php echo htmlspecialchars($item->title, ENT_QUOTES, 'UTF-8'); ?>">
