...
$labelClass = (!$showLabel ? 'd-none ' : '') . 'finder' . $suffix;
...
{
	$button = '<div class="input-group-append"><button class="btn btn-primary hasTooltip ' . ' finder' . $suffix . '" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><i class="fas fa-search"></i></button></div>';
...
<div class="finder<?php echo $suffix; ?>">
	<form id="mod-finder-searchform<?php echo $module->id; ?>" action="<?php echo JRoute::_($route); ?>" method="get" class="form-search input-group input-group-sm" role="search">
		<?php
